...
<div id='menu'>
	<center>
		<div id='menu-block'>
			...
			<a class='menu-item' href='armory.php'>Армори</a>
			<a class='menu-item' href='guides.php'>Начать играть</a>
			<a class='menu-item' href='forum.php'>Форум <label style="font-size:10px;color:lime;">alpha</label></a>
			<a class='menu-item' href='rules.php'>Правила</a>
			<?php if (isset($_SESSION['usr'])){
				echo "<a class='menu-item' href='store.php'>Магазин <label style='font-size:10px;color:lime;'>alpha</label></a>";
				echo "<a class='menu-item' href='user.php'>Личный кабинет</a>";
				echo "<a class='menu-item' href='?Logout.php'>Выйти</a>";
			} else{
				echo "<a class='menu-item' href='login.php'>Войти</a>"; 
				echo "<a class='menu-item' href='register.php'>Регистрация</a>"; 
			}?>
		</div>
	</center>
</div>
